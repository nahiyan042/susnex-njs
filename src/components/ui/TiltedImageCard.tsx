...
/**
 * 3D tilt card with cursor parallax, springy rotation, an overlay layer
 * that floats above the image (translateZ), and a small caption tooltip
 * that follows the cursor. Adapted from React Bits but uses Next.js
 * Image and the project's framer-motion install.
 */
